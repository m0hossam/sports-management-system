...
namespace SportsWebApp.Controllers
{
    public class DummiesController : Controller
    {
        ...
        public DummiesController(SportsWebAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Dummy != null ? 
                          ...
                          Problem("Entity set 'SportsWebAppContext.Dummy'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age")] Dummy dummy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age")] Dummy dummy)
        {
            if (id != dummy.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SportsWebAppContext.Dummy'  is null.");
            }
            var dummy = await _context.Dummy.FindAsync(id);
            if (dummy != null)
            {
