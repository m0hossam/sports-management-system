...
namespace SportsWebApp.Controllers
{
    ...
    public class FansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,NationalId,Phone,DateOfBirth,Address,IsBlocked")] Fan fan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,NationalId,Phone,DateOfBirth,Address,IsBlocked")] Fan fan)
        {
            if (id != fan.Id)
            {
                return NotFound();
        ...
        {
          return (_context.Fans?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
